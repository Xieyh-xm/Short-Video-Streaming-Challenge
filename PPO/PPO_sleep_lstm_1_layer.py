...
class ActorCritic(nn.Module):
    def __init__(self, state_dim, action_dim, has_continuous_action_space, action_std_init):
        ...
        if has_continuous_action_space:
            ...
            self.lstm_actor = nn.LSTM(input_size=1, hidden_size=10, num_layers=1, batch_first=True)
            self.actor = nn.Sequential(
        ...
        self.lstm_critic = nn.LSTM(input_size=1, hidden_size=10, num_layers=1, batch_first=True)
    ...
    def evaluate(self, state, action):
        ...
        if self.has_continuous_action_space:
            ...
            h_out_actor = h_actor[0, :, :]  # 取最后一层10个输出
        ...
        h_out_critic = h_critic[0, :, :]  # 取最后一层10个输出
