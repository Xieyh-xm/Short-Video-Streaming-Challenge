...
def mpc(past_bandwidth, past_bandwidth_ests, past_errors, all_future_chunks_size, P, buffer_size, chunk_sum,
    ...
    for combo in CHUNK_COMBO_OPTIONS:
        ...
        for position in range(0, len(combo)):
            ...
            download_time = MILLISECONDS_IN_SECOND * (all_future_chunks_size[chunk_quality][position] / 1000000.) / (
