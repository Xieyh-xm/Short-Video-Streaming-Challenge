...
from RL_env.RL_env_sleep_high import RLEnv
...
def train():
    ...
    ppo_agent = PPO(state_dim, action_dim, lr_actor, lr_critic, gamma, K_epochs, eps_clip, has_continuous_action_space,
                    action_std)
    ppo_agent.load(directory + "PPO_{}_{}_{}.pth".format(env_name, random_seed, 0))
